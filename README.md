...
Вебзастосунок для ведення земельних ділянок: карта, картки ділянок, категорії та впорядкований довідник статусів, імпорт GeoJSON/PDF окремими файлами або з ZIP, журнал змін, звіти, керування користувачами та окремі робоча/тестова області даних.
