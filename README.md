...
Вебзастосунок для ведення земельних ділянок: карта, картки ділянок, категорії та впорядкований довідник статусів, імпорт GeoJSON/PDF окремими файлами або з ZIP, журнал змін, desktop/mobile-звіти з експортом PDF/DOCX/Excel, керування користувачами та окремі робоча/тестова області даних.
