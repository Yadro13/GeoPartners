...
Вебзастосунок для ведення земельних ділянок: карта, картки ділянок, імпорт GeoJSON/PDF, журнал змін, звіти, керування користувачами та окремі робоча/тестова області даних.
