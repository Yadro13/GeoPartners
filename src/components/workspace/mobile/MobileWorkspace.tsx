...
export function MobileWorkspace(props: WorkspaceViewProps) {
  ...
  return <main className="mobile-shell" data-workspace={props.workspace} data-has-workspace-switch={!props.preview && props.testWorkspaceEnabled}>
    ...
    <section className="mobile-content">
      ...
      {props.activeSection !== "users" && tab === "reports" ? <ReportsPanel plots={props.plots} categories={props.categories} plotStatuses={props.plotStatuses} resultStatusProgress={props.resultStatusProgress} actions={props.actions} canViewExpenses={props.canViewExpenses} /> : null}
