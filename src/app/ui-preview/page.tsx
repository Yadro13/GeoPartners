...
export default async function UiPreviewPage({ searchParams }: { searchParams: Promise<{ role?: string; access?: string; google?: string }> }) {
  if (process.env.NODE_ENV === "production") notFound();
  const { role, access, google } = await searchParams;
