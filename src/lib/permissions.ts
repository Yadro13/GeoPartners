...
const adminPermissions = new Set<AppPermission>(["plots.create", "plots.update", "plots.delete", "imports.run", "categories.manage", "versions.restore", "users.manage", "workspaces.manage"]);
