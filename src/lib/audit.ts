...
export const auditActions = ["plot.created", "plot.updated", "plot.deleted", "plot.restored", "import.completed", "plot-statuses.updated", "result-status-progress.updated", "workspace.snapshot.created"] as const;
...
const plotFieldLabels: Record<string, string> = {
  ...
  statusProgress: "Етапи та витрати",
  mainCandidateCadastral: "Основний кандидат",
  owner: "Власник",
  lessee: "Орендар",
  roadOwnershipType: "Форма власності дороги",
  servitudeValidFrom: "Початок дії сервітуту",
  servitudeValidUntil: "Закінчення дії сервітуту",
  servitudePaymentAmount: "Сума оплати сервітуту",
  servitudePaymentPeriod: "Періодичність оплати сервітуту",
  substationType: "Тип підстанції",
  substationCapacityMw: "Потужність підстанції",
...
function plotSnapshot(plot: PlotFeature): Record<string, unknown> {
  ...
  return {
    ...
    statusProgress: properties.statusProgress ?? [],
    mainCandidateCadastral: properties.mainCandidateCadastral,
    owner: properties.owner,
    lessee: properties.lessee,
    roadOwnershipType: properties.roadOwnershipType,
    servitudeValidFrom: properties.servitudeValidFrom,
    servitudeValidUntil: properties.servitudeValidUntil,
    servitudePaymentAmount: properties.servitudePaymentAmount,
    servitudePaymentPeriod: properties.servitudePaymentPeriod,
    substationType: properties.substationType,
    substationCapacityMw: properties.substationCapacityMw,
