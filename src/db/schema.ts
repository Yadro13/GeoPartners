...
export const plot = pgTable(
  "plot",
  {
    ...
    roadOwnershipType: text("road_ownership_type").default("").notNull(),
    servitudeValidFrom: text("servitude_valid_from").default("").notNull(),
    servitudeValidUntil: text("servitude_valid_until").default("").notNull(),
    servitudePaymentAmount: numeric("servitude_payment_amount", { precision: 14, scale: 2 }),
    servitudePaymentPeriod: text("servitude_payment_period").default("").notNull(),
    substationType: text("substation_type").default("").notNull(),
    substationCapacityMw: numeric("substation_capacity_mw", { precision: 12, scale: 3 }),
